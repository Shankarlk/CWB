    ...
    public class AutoMapping : Profile
    {
        public AutoMapping()
        {
            ...
            CreateMap<Domain.City, CityVM>()
             ...
             .ForMember(m => m.Name, m => m.MapFrom(src => src.Name))
             .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Dept_Role_ListVM, Dept_Role_List>()
                .ForMember(m => m.Id, m => m.MapFrom(src => src.Dept_Role_ListId))
                .ForMember(m => m.Role_Access_Id, m => m.MapFrom(src => src.Role_Access_Id))
                .ForMember(m => m.Dept_Struct_Id, m => m.MapFrom(src => src.Dept_Struct_Id))
                .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Domain.Dept_Role_List, Dept_Role_ListVM>()
             .ForMember(m => m.Dept_Role_ListId, m => m.MapFrom(src => src.Id))
                .ForMember(m => m.Role_Access_Id, m => m.MapFrom(src => src.Role_Access_Id))
                .ForMember(m => m.Dept_Struct_Id, m => m.MapFrom(src => src.Dept_Struct_Id))
             .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Dept_EmployeeVM, Dept_Employee>()
                .ForMember(m => m.Id, m => m.MapFrom(src => src.Dept_EmployeeId))
                .ForMember(m => m.Dept_Posn, m => m.MapFrom(src => src.Dept_Posn))
                .ForMember(m => m.Employee_Id, m => m.MapFrom(src => src.Employee_Id))
                .ForMember(m => m.Active, m => m.MapFrom(src => src.Active))
                .ForMember(m => m.Add_date, m => m.MapFrom(src => src.Add_date))
                .ForMember(m => m.Deact_date, m => m.MapFrom(src => src.Deact_date))
                .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Domain.Dept_Employee, Dept_EmployeeVM>()
             .ForMember(m => m.Dept_EmployeeId, m => m.MapFrom(src => src.Id))
                .ForMember(m => m.Dept_Posn, m => m.MapFrom(src => src.Dept_Posn))
                .ForMember(m => m.Employee_Id, m => m.MapFrom(src => src.Employee_Id))
                .ForMember(m => m.Active, m => m.MapFrom(src => src.Active))
                .ForMember(m => m.Add_date, m => m.MapFrom(src => src.Add_date))
                .ForMember(m => m.Deact_date, m => m.MapFrom(src => src.Deact_date))
             .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Employee_UI_ListVM, Employee_UI_List>()
                .ForMember(m => m.Id, m => m.MapFrom(src => src.Employee_UI_ListId))
                .ForMember(m => m.Ui_Id, m => m.MapFrom(src => src.Ui_Id))
                .ForMember(m => m.Access_Level, m => m.MapFrom(src => src.Access_Level))
                .ForMember(m => m.Employee_Id, m => m.MapFrom(src => src.Employee_Id))
                .ForMember(m => m.Active, m => m.MapFrom(src => src.Active))
                .ForMember(m => m.Add_date, m => m.MapFrom(src => src.Add_date))
                .ForMember(m => m.Deact_date, m => m.MapFrom(src => src.Deact_date))
                .ForMember(m => m.TenantId, m => m.MapFrom(src => src.TenantId));
            CreateMap<Domain.Employee_UI_List, Employee_UI_ListVM>()
             .ForMember(m => m.Employee_UI_ListId, m => m.MapFrom(src => src.Id))
                .ForMember(m => m.Ui_Id, m => m.MapFrom(src => src.Ui_Id))
                .ForMember(m => m.Access_Level, m => m.MapFrom(src => src.Access_Level))
                .ForMember(m => m.Employee_Id, m => m.MapFrom(src => src.Employee_Id))
                .ForMember(m => m.Active, m => m.MapFrom(src => src.Active))
            ...
            CreateMap<ShopDepartment, ShopDepartmentVM>()
                ...
                .ForMember(m => m.Name, m => m.MapFrom(src => src.Name))
                .ForMember(m => m.Part_Of, m => m.MapFrom(src => src.Part_Of))
          ...
          .ForMember(m => m.FirstShiftStartTime, m => m.MapFrom(src => src.FirstShiftStartTime))
            ...
            CreateMap<EmployeeVM, Employee>()
              ...
              .ForMember(m => m.ChangedPassword, m => m.MapFrom(src => src.ChangedPassword))
