...
{
    public class GroDbContext:DbContext
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        public GroDbContext(DbContextOptions<GroDbContext> options, IHttpContextAccessor httpContextAccessor) :
           base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(GroDbContext).Assembly);
        }
