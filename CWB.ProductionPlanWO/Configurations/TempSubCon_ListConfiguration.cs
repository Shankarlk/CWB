...
{
    public class TempSubCon_ListConfiguration : IEntityTypeConfiguration<TempSubCon_List>
    {
        public void Configure(EntityTypeBuilder<TempSubCon_List> builder)
        {
            builder
                .ToTable("TempSubCon_List");
            builder
                .HasKey(b => b.Id);
            builder
            ...
            builder.HasIndex(c => c.TenantId).HasDatabaseName("TempSubCon_List_TenantId");
        }
    }
}
