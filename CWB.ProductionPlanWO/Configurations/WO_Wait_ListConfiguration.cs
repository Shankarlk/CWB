...
{
    public class WO_Wait_ListConfiguration : IEntityTypeConfiguration<WO_Wait_List>
    {
        public void Configure(EntityTypeBuilder<WO_Wait_List> builder)
        {
            builder
                .ToTable("WO_Wait_List");
            builder
                .HasKey(b => b.Id);
            builder
                .Property(b => b.Wo_Id)
            ...
            builder.HasIndex(c => c.TenantId).HasDatabaseName("WO_Wait_List_TenantId");
        }
    }
}
