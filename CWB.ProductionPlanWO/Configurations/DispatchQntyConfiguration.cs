...
{
    public class DispatchQntyConfiguration : IEntityTypeConfiguration<DispatchQnty>
    {
        public void Configure(EntityTypeBuilder<DispatchQnty> builder)
        {
            builder
                .ToTable("DispatchQnty");
            builder
                .HasKey(b => b.Id);
            builder
            ...
            builder
                .Property(b => b.TotalSoQnty)
                .HasColumnName("TotalSoQnty");
            builder
