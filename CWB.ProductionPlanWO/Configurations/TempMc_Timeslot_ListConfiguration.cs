...
{
    public class TempMc_Timeslot_ListConfiguration : IEntityTypeConfiguration<TempMc_Timeslot_List>
    {
        public void Configure(EntityTypeBuilder<TempMc_Timeslot_List> builder)
        {
            builder
                .ToTable("TempMc_Timeslot_List");
            builder
                .HasKey(b => b.Id);
            builder
            ...
            builder.HasIndex(c => c.TenantId).HasDatabaseName("TempMc_Timeslot_List_TenantId");
        }
    }
}
