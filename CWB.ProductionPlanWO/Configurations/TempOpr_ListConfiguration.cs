...
{
    public class TempOpr_ListConfiguration : IEntityTypeConfiguration<TempOpr_List>
    {
        public void Configure(EntityTypeBuilder<TempOpr_List> builder)
        {
            builder
                .ToTable("TempOpr_List");
            builder
                .HasKey(b => b.Id);
            builder
                .Property(b => b.Wo_Id)
            ...
            builder.HasIndex(c => c.TenantId).HasDatabaseName("TempOpr_List_TenantId");
        }
    }
}
